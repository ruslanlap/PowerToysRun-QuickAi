...
# 🤖 QuickAI for PowerToys Run

<img src="assets/logo.png" alt="QuickAI Icon" width="128" height="128">

### ⚡ AI-Powered Assistance Right at Your Fingertips ⚡
...
### 🚀 v1.4.1 - More Providers & Anthropic Support

- **13 new provider presets**: Anthropic, Zhipu, xAI, Perplexity, Mistral, Cerebras, SambaNova, Fireworks AI, NVIDIA NIM, DeepInfra, Novita, SiliconFlow + more
- **Anthropic Messages API**: native support with system prompts and streaming
- **OpenAI Compatible**: no default model — set both endpoint and model explicitly
- Fixes: Anthropic temperature now always sent; SSE stream timeout enforced
- Contributed by [@Greyaircraft](https://github.com/Greyaircraft)
...
wget https://github.com/ruslanlap/PowerToysRun-QuickAi/releases/latest
...
1. Open PowerToys Settings → PowerToys Run → Plugins → QuickAI
2. Enter your API key for the preferred provider
3. Hit `Alt+Space` → Type `ai what is quantum computing?` → Marvel at the magic! ✨
...
[![Star this repo](https://img.shields.io/badge/⭐_Star_on_GitHub-ffcc00?style=for-the-badge&logo=github&logoColor=black)](https://github.com/ruslanlap/PowerToysRun-QuickAi/stargazers)
[![Tweet about it](https://img.shields.io/badge/Tweet-1DA1F2?style=for-the-badge&logo=twitter&logoColor=white)](https://twitter.com/intent/tweet?text=Just%20found%20this%20amazing%20PowerToys%20Run%20plugin%20for%20AI%20assistance!%20🤖&url=https://github.com/ruslanlap/PowerToysRun-QuickAi)
...
- 🐛 [Report bugs](https://github.com/ruslanlap/PowerToysRun-QuickAi/issues)
- 💡 [Request features](https://github.com/ruslanlap/PowerToysRun-QuickAi/issues)  
...
- ✅ **Check path**: `%LOCALAPPDATA%\Microsoft\PowerToys\PowerToys Run\Plugins\QuickAi`  
...
PowerToys Settings → PowerToys Run → Plugins → QuickAI → Select provider from dropdown
</details>
...
- ✅ **Local Plugin**: All plugin functionality runs locally
